angular.module('template-module', []).run(['$templateCache', function($templateCache) {
  $templateCache.put("js/user/modules/common/menu/menu.tpl.html",
    "<div>\n" +
    ...
    "  </div>\n" +
    "</div>");
  $templateCache.put("js/user/modules/home/home.tpl.html",
    "{{pageTitle}}");
  $templateCache.put("js/user/modules/profile/profile.tpl.html",
